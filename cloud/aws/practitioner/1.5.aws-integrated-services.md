...
- AWS CodeDeploy
  - Serviço de Implantação Automática de Aplicaões. Totalmente gerenciado, controle centralizado, independente de lingagns e arquiteturas, integração com as demais ferramentas AWS. Possui monitoramento Integridade das implantacoes.
...
Fornece uma **visao detalhada** da configuracao dos recursos AWS em sua conta. Qualquer recurso que esteja habilitado em sua conta é registrada e pode ser gerenciada pelo AWS Config.
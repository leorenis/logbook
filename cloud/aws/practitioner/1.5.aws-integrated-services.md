...
- AWS CodeDeploy
  - Serviço de Implantação Automática de Aplicaões. Totalmente gerenciado, controle centralizado, independente de linguagem e arquiteturas, integração com as demais ferramentas AWS. Possui monitoramento Integridade das implantacoes.

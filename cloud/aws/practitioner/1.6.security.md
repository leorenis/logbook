...
- AWS Shield Advanced
  ...
  - Usado para identificar cono Application Load Balancers respondem a requisicoes Web
  ...
  - Rules
    ...
    - A Requisicao continuará a ser processada pela WEB ACL para se satisfaz outras Rules associadas

  - Web ACL
    - Lista de Rules nas quais são aplicadas Aactions, podendo ser Allow, Block ou Count
    ...
    - Uma vez que uma Rule é satisfeita, será analisada a próxima Rule dentra da **Web ACL**.